...
const Profile = () => {
  const user = {
    name: "User Singh",
    email: "user.singh@example.com",
    mobile: "+1234567890",
    photoUrl: require("../../assets/images/seller-photo.png"),
  ...
  return (
    <View className="bg-white h-full w-full px-4 py-2">
      <View className="flex-row justify-between items-center bg-gray-100 p-3 m-1 rounded-2xl">
        ...
        <TouchableOpacity className="bg-red-500 rounded-lg p-2 flex-row items-center ">
          <MaterialIcons
            name="logout"
            size={20}
            color="white"
      ...
      <View className="flex-row justify-around item-center gap-2 p-1 rounded">
        <View className="relative bg-gray-100 rounded-2xl p-1">
          <Image source={user.photoUrl} className="w-36 h-36 rounded-full" />
